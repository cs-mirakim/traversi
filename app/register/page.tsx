  ...
  return (
    <div className="min-h-screen bg-[#fcfdfd] text-[#0f172a] flex items-center justify-center p-4 sm:p-6 md:p-10">
      <div className="w-full max-w-5xl bg-white rounded-3xl border border-stone-200 shadow-xl overflow-hidden grid grid-cols-1 lg:grid-cols-12 min-h-[640px]">
        ...
        {/* =========================================================================
            RIGHT COLUMN: SIGN UP FORM (lg:col-span-7)
        ========================================================================= */}
        <div className="lg:col-span-7 p-6 sm:p-10 flex flex-col justify-between space-y-6">
          ...
          <div className="space-y-2 text-center sm:text-left">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-50 text-emerald-800 text-xs font-bold border border-emerald-200">
              ...
              <span>{locale === "bm" ? "Pendaftaran 1-Klik Percuma" : "Free 1-Click Signup"}</span>
            </div>
            <h1 className="text-2xl sm:text-3xl font-black text-stone-950 tracking-tight">
              {locale === "bm" ? "Daftar Akaun Traversi" : "Sign Up for Traversi"}
            </h1>
            <p className="text-xs sm:text-sm text-stone-600 font-medium leading-relaxed">
              {locale === "bm"
                ? "Daftar serta-merta dengan Google atau cuba profil segera Hang Tuah."
                : "Register instantly with Google or test via instant Hang Tuah profile."}
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <span>{locale === "bm" ? "Daftar Segera Sebagai Hang Tuah (Demo)" : "Instant Demo Sign Up (Hang Tuah)"}</span>
            </button>
          </div>
          ...
          <div className="pt-2 border-t border-stone-100 space-y-2 text-stone-600 text-xs font-medium">
            <div className="flex items-center gap-2">
              ...
              <span>{locale === "bm" ? "100% percuma tanpa sebarang caj tersembunyi" : "100% free with zero hidden charges"}</span>
            </div>
            <div className="flex items-center gap-2">
              <CheckCircle2 className="w-3.5 h-3.5 text-emerald-700 shrink-0" />
              <span>{locale === "bm" ? "Simpan carian bajet dan tandakan destinasi pilihan" : "Save trip calculations and bookmark destinations"}</span>
            </div>
            <div className="flex items-center gap-2">
              <ShieldCheck className="w-3.5 h-3.5 text-emerald-700 shrink-0" />
              <span>{locale === "bm" ? "Infrastruktur profil selamat di awan Supabase" : "Secure cloud profile infrastructure on Supabase"}</span>
            </div>
          </div>
