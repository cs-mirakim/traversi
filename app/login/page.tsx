...
import { Compass, LogIn, ArrowLeft, CheckCircle2 } from "lucide-react";
          ...
          {success ? (
            <div className="py-8 text-center space-y-2 animate-in fade-in">
              ...
              <p className="font-bold text-stone-900 text-base">
                {locale === "bm" ? "Berjaya Log Masuk!" : "Login Successful!"}
              </p>
              <p className="text-xs text-stone-500">
                {locale === "bm" ? "Membawa anda ke halaman profil..." : "Redirecting to your profile..."}
              </p>
            </div>
          ) : (
            <div className="space-y-5">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                >
                  ...
                  <span>{isLoading ? (locale === "bm" ? "Memproses..." : "Processing...") : (locale === "bm" ? "Log Masuk" : "Sign In")}</span>
                </button>
              </form>
